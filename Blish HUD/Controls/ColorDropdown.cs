    ...
    public class ColorDropdown : Dropdown {
        ...
        protected override void Paint(SpriteBatch spriteBatch, Rectangle bounds) {
            ...
            DrawSelectedItem(spriteBatch, 
                             new Rectangle(bounds.X + COLOR_SIZE * 2, 
                                           bounds.Y, 
        ...
        protected override void PaintItemPanelItemText(SpriteBatch spriteBatch, Rectangle bounds, string itemText, Color textColor) {
            base.PaintItemPanelItemText(spriteBatch,
                                        new Rectangle(bounds.X + COLOR_SIZE * 2,
                                                                   bounds.Y,
                                                                   bounds.Width - COLOR_SIZE * 2,
                                                                   bounds.Height),
        ...
        //protected override void PaintItemPanel(SpriteBatch spriteBatch, Rectangle bounds, int highlightedItem) {
            //    PaintItemPanelBacking(spriteBatch, bounds, highlightedItem);
            //    PaintItemPanelItems(spriteBatch,
            //                        new Rectangle(bounds.X + COLOR_SIZE * 2,
            //                                                   bounds.Y,
            //                                                   bounds.Width - COLOR_SIZE * 2,
            //                                                   bounds.Height), 
